...
export function Skater({ skater, index }: Props) {
  ...
  return (
    <div className="skater group relative flex flex-col items-center gap-4 overflow-hidden">
      <PrismicNextImage
      ...
      />
      <div className="relative h-48 w-full bg-gradient-to-t from-black via-transparent to-transparent"></div>
      <h3 className="relative p-2 font-sans text-brand-gray text-2xl md:text-3xl">
